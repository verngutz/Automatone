...
namespace Automatone.GUI
{
    public class ControlPanel : SkinNamedWindowControl
    {
        ...
        public void ResetButtonsetBounds()
        {
            ...
            newButton.Bounds = buttonsetBounds.ElementAt<UniRectangle>(2);
            openButton.Bounds = buttonsetBounds.ElementAt<UniRectangle>(3);
            saveButton.Bounds = buttonsetBounds.ElementAt<UniRectangle>(4);
            ...
            generateSongButton.Bounds = buttonsetBounds.ElementAt<UniRectangle>(12);
