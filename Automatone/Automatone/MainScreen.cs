...
namespace Automatone
{
    class MainScreen : MSScreen
    {
        ...
        public MainScreen(Texture2D background, SpriteBatch spriteBatch, Game game)
            : this(background, 0, 0, 0, 0, Color.White, spriteBatch, game) { }
        
        public MainScreen(Texture2D background, Color highlight, SpriteBatch spriteBatch, Game game)
            : this(background, 0, 0, 0, 0, highlight, spriteBatch, game) { }
        
        public MainScreen(Texture2D background, float topPadding, float bottomPadding, float leftPadding, float rightPadding, SpriteBatch spriteBatch, Game game)
            : this(background, topPadding, bottomPadding, leftPadding, rightPadding, Color.White, spriteBatch, game) { }
        
        public MainScreen(Texture2D background, float topPadding, float bottomPadding, float leftPadding, float rightPadding, Color highlight, SpriteBatch spriteBatch, Game game)
            : base(background, topPadding, bottomPadding, leftPadding, rightPadding, highlight, spriteBatch, game)
        {
            ...
            topLeftPanel = new MSPanel(null, new Rectangle(0, 0, 30 * 16, 150), null, Shape.RECTANGULAR, spriteBatch, game);

            MSPanel basicPanel = new MSPanel(game.Content.Load<Texture2D>("darkblue"), new Rectangle(0, 45, 30 * 16, 105), 6, 6, 25, 15, null, Shape.RECTANGULAR, spriteBatch, game);
            ...
            topRightPanel = new MSPanel(game.Content.Load<Texture2D>("darkblue"), new Rectangle(30 * 16, 0, 20 * 16, 150), 10, 5, 85, 85, null, Shape.RECTANGULAR, spriteBatch, game);
            ...
            topPanel = new MSPanel(null, new Rectangle(0, 0, 50 * 16, 150), null, Shape.RECTANGULAR, spriteBatch, game);
            topPanel.AddComponent(topLeftPanel);
            topPanel.AddComponent(topRightPanel);

            gridPanel = new MSPanel(null, new Rectangle(0, 150, 50 * 16, 44 * 16), null, Shape.RECTANGULAR, spriteBatch, game);
                    ...
                    gridPanel.AddComponent(
                        new MSImageHolder(
                            new Rectangle(
                                ...
                                16, 16),
                            (r.NextDouble() > 0.8 ? game.Content.Load<Texture2D>("lightbox") : game.Content.Load<Texture2D>("darkbox")),
                            spriteBatch,
                            game));
                }
            }
